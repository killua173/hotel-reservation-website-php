	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<?php
					$query = $conn->query("SELECT * FROM `reservations`  NATURAL JOIN `room` WHERE `transaction_id` = '$_REQUEST[transaction_id]'") or die(mysqli_error());
				...
				<form method = "POST" enctype = "multipart/form-data" action = "save_form.php?transaction_id=<?php echo $fetch['transaction_id']?>">
					<div class = "form-inline" style = "float:left;">
						...
						<br />
						<input type = "text" value = "<?php echo $fetch['full name']?>" class = "form-control" size = "40" disabled = "disabled"/>
					</div>
