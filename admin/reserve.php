...
<body>
		...
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `reservations` NATURAL JOIN `room` WHERE `status` = 'Pending'") or die(mysqli_error());
    ...
    $daysSpend = floor(($checkOut - $checkIn) / (60 * 60 * 24)); // Calculating the number of days spent
